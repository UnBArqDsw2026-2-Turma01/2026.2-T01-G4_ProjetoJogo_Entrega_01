...
Cada subgrupo é responsável por seu próprio relatório, contendo a entrega mínima: um artefato generalista (Rich Picture ou Mapa Mental), um SIG na notação do NFR Framework, um modelo BPMN de um fluxo levantado por Engenharia Reversa, e os pontos de vista dos membros sobre o uso de IA Generativa.
...
| [Base](/Base/1.Base.md) | Módulo Desenho de Software: Design Sprint, relatórios das subequipes, participações e iniciativas extras. |
