...
![Recriação por IA do Rich Picture do RPG educacional de matemática](assets/subgrupo01_rich_picture_v3.png)

<p align="center">Figura 1: Recriação experimental do Rich Picture do RPG educacional de matemática. Fonte: ChatGPT, modelo GPT-5.6 Sol Alto, a partir de prompt elaborado pelo Subgrupo 01, 2026.</p>
...
![Recriação por IA do Rich Picture da plataforma de jogos de estimulação cognitiva](assets/subgrupo01_rich_picture_v4.png)

<p align="center">Figura 2: Recriação experimental do Rich Picture da plataforma de jogos de estimulação cognitiva. Fonte: ChatGPT, modelo GPT-5.6 Sol Alto, a partir de prompt elaborado pelo Subgrupo 01, 2026.</p>
