...
Modelagem de processo de negócio da SubEquipe_01, no escopo do **FOCO_02 — Engenharia Reversa & Modelagem BPMN**. Representa, na notação BPMN, um fluxo do software levantado por Engenharia Reversa.
...
*Descrever o contexto no qual foi aplicada a Engenharia Reversa, o processo seguido, as etapas percorridas, as ferramentas utilizadas e os achados. Embasar na literatura as colocações.*

## Conteúdo

### Processo de Engenharia Reversa Aplicado

*Descrever o processo aplicado e os achados.*

### Modelagem BPMN

*Inserir aqui o modelo BPMN do fluxo levantado, com legenda e fonte.*

<p align="center">Figura 1: Modelo BPMN do fluxo de &lt;&lt;nome do fluxo&gt;&gt;. Fonte: Autores, 2026.</p>
