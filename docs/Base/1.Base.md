...
A Wiki ou GitPages do Projeto deve conter um tópico dedicado ao Módulo Desenho de Software (Base), com uma subpasta Relatórios (1.1), contendo o relatório de cada subequipe dividido por foco: [SubEquipe_01](/Base/Relatórios/SubEquipe_01/ArtefatoGeneralista.md), [SubEquipe_02](/Base/Relatórios/SubEquipe_02/ArtefatoGeneralista.md) e [SubEquipe_03](/Base/Relatórios/SubEquipe_03/ArtefatoGeneralista.md). Adicionalmente, deve constar um subtópico sobre as participações, conforme [1.2](/Base/1.2.ParticipacoesBase.md).  **Cada subequipe deve revelar principalmente: Rastreabilidade & Elos com Outros Artefatos, Senso Crítico, Referências, Versionamentos & Participações e Metodologia.**
